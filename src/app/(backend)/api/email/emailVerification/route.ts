        ...
        try {
            const info = await transporter.sendMail({
                ...
                ">
                    ...
                    This is an email confirmation from
                    <strong>Multiplayer Chess Game</strong>.<br />
                    Please verify your email to unlock full access and start playing
                    real-time chess matches online with your friends.<br /><br />
                    ...
                    margin:0;
                    ">
                    If you didn’t create an account on Multiplayer Chess Game,
